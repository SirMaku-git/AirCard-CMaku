        ...
        ui.columns(2, |cols| {
            ...
            m3_card(right, |ui| {
                ...
                let layer_hint = if is_vi {
                    match self.active_layer {
                        ActiveTransformLayer::Background => "Lớp đang chọn: Nền thẻ (Kéo chuột để di chuyển • Cuộn chuột để thu phóng)",
                        ActiveTransformLayer::Finish => "Lớp đang chọn: Finish Texture (Kéo chuột để di chuyển • Cuộn chuột để thu phóng)",
                        ActiveTransformLayer::Chip => "Lớp đang chọn: Chip EMV (Kéo chuột để di chuyển • Cuộn chuột để đổi cỡ)",
                        ActiveTransformLayer::Logo => "Lớp đang chọn: Logo thương hiệu (Kéo chuột để di chuyển • Cuộn chuột để đổi cỡ)",
                    }
                } else {
                    match self.active_layer {
